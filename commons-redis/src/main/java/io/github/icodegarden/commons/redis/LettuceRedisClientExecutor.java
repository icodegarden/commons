 ...
 *
 */
public class LettuceRedisClientExecutor implements RedisExecutor {
	private static final Logger log = LoggerFactory.getLogger(LettuceRedisClientExecutor.class);

	private RedisClient client;
	private StatefulRedisConnection<byte[], byte[]> connection;
	private RedisCommands<byte[], byte[]> syncRedisCommands;

	public LettuceRedisClientExecutor(RedisClient client) {
		this.client = client;
